...
public static void main(String... args) {
	BankAccount b1=new BankAccount(1,"Laxman Ramancha",1000,AccountType.currentAccount);
	BankAccount b2=new BankAccount(2,"Srija",5453,AccountType.currentAccount);
	BankAccount b3=new BankAccount(3,"Somu",3333,AccountType.savingsAccount);
